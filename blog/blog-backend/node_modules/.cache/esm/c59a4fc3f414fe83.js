let Post,mongoose,Joi,sanitizeHtml;_f41‍.x([["getPostById",()=>getPostById],["checkOwnPost",()=>checkOwnPost],["write",()=>write],["list",()=>list],["read",()=>read],["remove",()=>remove],["update",()=>update]]);_f41‍.w("../../models/post",[["default",["Post"],function(v){Post=v}]]);_f41‍.w("mongoose",[["default",["mongoose"],function(v){mongoose=v}]]);_f41‍.w("@hapi/joi",[["default",["Joi"],function(v){Joi=v}]]);_f41‍.w("sanitize-html",[["default",["sanitizeHtml"],function(v){sanitizeHtml=v}]]);
// ObjectId 검증
