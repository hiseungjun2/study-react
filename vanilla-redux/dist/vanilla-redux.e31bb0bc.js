...
var btnDecrease = document.querySelector('#decrease'); // 액션(action) 이름 정의

var TOGGLE_SWITCH = 'TOGGLE_SWITCH';
var INCREASE = 'INCREASE';
var DECREASE = 'DECREASE'; // 액션 함수 생성
...
var store = (0, _redux.createStore)(reducer); // render 함수 생성

var render = function render() {
  var state = store.getState(); // 현재 상태 가져오기
  // 토글 처리
...
render(); // 구독하기 (스토어의 상태가 바뀔 때 마다 render 함수 호출 되도록)

store.subscribe(render); // 액션 발생 시키기 (디스패치)
